...
- **Verify SSR before hydration.** A hydrated query cache does not prove the first frame is rendered: inspect the JavaScript-disabled page at each responsive layout, and verify first-navigation preloads separately from hard requests.
