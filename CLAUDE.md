...
- **The points ratchet is a ratchet.** `just points` matches 100% of 1,862 reference checks. A lower result is a regression unless the generated check set changed and the new baseline is explained.
