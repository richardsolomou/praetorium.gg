...
- **A standing is folded, never stored.** The leaderboard counts finished battles anyone may watch, over a bounded window and a bounded number of logs, and a concession loses whatever the points said. Battles involving a practice opponent do not count. Holding the folded answer for a minute is allowed because it is derived; a battle screen may never make that trade.
