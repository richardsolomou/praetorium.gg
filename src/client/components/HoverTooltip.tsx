  ...
  return (
    ...
    >
      ...
      <TooltipContent
        ...
        side="bottom"
        sideOffset={6}
        className="z-50 block max-h-[min(18rem,calc(100vh-1rem))] w-66 max-w-[calc(100vw-1rem)] overflow-hidden p-0 text-left"
      >
        ...
        {body ? (
          <div className="max-h-56 overflow-y-auto px-2.5 py-1.5 font-rules text-xs text-dim">
