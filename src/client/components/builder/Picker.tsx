...
import { setOwned } from '../../../server/fns'
 ...
 * three filters narrow by the three reasons a datasheet is not a real option today:
 * it does not fit, you may not take another, or you do not own it.
 */
