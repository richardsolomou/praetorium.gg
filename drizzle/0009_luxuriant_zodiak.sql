CREATE TABLE "league_event_entries" (
	...
	"submitted_at" bigint,
	CONSTRAINT "league_event_entries_event_id_user_id_pk" PRIMARY KEY("event_id","user_id")
);
...
--> statement-breakpoint
INSERT INTO "league_event_entries" ("event_id", "user_id", "status", "joined_at", "roster_id", "roster_name", "roster_snapshot", "submitted_at")
SELECT "league_id", "user_id", "status", "joined_at", "roster_id", "roster_name", "roster_snapshot", "submitted_at" FROM "league_entries";
--> statement-breakpoint
DROP TABLE "league_entries" CASCADE;--> statement-breakpoint
