...
COPY scripts/containerRuntime.ts scripts/importOnBoot.ts scripts/importSqlite.ts scripts/importSqliteCli.ts scripts/migrate.ts scripts/previewDatabase.ts scripts/previewEnv.ts scripts/seedPreview.ts ./scripts/
