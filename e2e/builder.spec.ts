...
test("Pantheon of Woe adds a C'tan shard's required enhancement", async ({ page }) => {
  ...
  await expect(noble).toHaveCSS('color', 'rgb(216, 203, 170)')
  await expect(datasheet.getByText('Character', { exact: true })).toHaveCSS('color', 'rgb(216, 203, 170)')
  ...
  await expect(referenceHeader.getByText('Noble', { exact: true })).toHaveCSS('color', 'rgb(216, 203, 170)')
