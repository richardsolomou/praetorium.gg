...
CREATE UNIQUE INDEX `account_provider_account` ON `account` (`providerId`,`accountId`);--> statement-breakpoint
CREATE TABLE `jwks` (
	`id` text PRIMARY KEY NOT NULL,
...
CREATE INDEX `user_createdAt_id_idx` ON `user` (`createdAt`,`id`);--> statement-breakpoint
