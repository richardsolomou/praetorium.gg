...
- Praetorium's two-player, account-backed, conflict-safe live state remains the foundation rather than something to copy from either product.
...
| --------------------- | ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Account identity      | Done                      | Email and password accounts require no provider configuration; optional Google and Discord sign-in appear when configured.                                                                                                               |
...
- A player can browse Factions before signing in; Battles and Rosters ask them to sign in before creating player-owned state.
