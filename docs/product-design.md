...
- Public or private organized-play registration with reusable events, approved entry, replaceable sealed roster snapshots, and simultaneous reveal.
...
| Leagues           | Public or private reusable events, automatic or approved entry, replaceable roster snapshots, and organizer-controlled simultaneous reveal.                                                                                                   |
