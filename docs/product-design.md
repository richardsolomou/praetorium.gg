...
- A public combat simulator that automatically compares shooting and melee from catalogue loadouts, using one compact matchup view for future roster and battle dialogs.
