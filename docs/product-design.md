...
- Public or private organized-play registration with one-off or recurring events, approved entry, replaceable sealed roster snapshots, simultaneous reveal, and read-only event battle viewing.
...
| Leagues           | Public or private one-off and recurring events, automatic or approved entry, replaceable roster snapshots, organizer-controlled simultaneous reveal, and live or finished battle viewing.                                                     |
