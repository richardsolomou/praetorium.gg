...
- At the end of a turn, after scoring, offer to discard one active tactical secondary for 1 CP when that side has not used its additional CP gain this round. Record the discard and CP together so undo reverses the whole choice.
