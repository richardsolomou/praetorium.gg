...
- Grant both sides 1 CP at the start of every command phase. Track additional command point gains separately from that grant and score corrections. Each side can gain at most one additional CP per battle round, and spending it does not reopen that allowance.
