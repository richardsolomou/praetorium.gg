...
- King of the Colosseum requires tactical secondaries. Its 2.0 battlefield and twists remain absent until an upstream source supplies the current structured data; do not expose the older 9-inch deployment as the prototype's 8-inch deployment.
