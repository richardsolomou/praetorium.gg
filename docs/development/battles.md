...
During setup, each catalogue-backed army can place at most half its battle-size points limit in Strategic Reserves. Deep Strike units count towards the same limit because the ability changes their ingress rather than removing them from Strategic Reserves. Source-declared exemptions and units redeployed after deployment do not count. After the first-turn roll, returning a battlefield unit to Strategic Reserves through the Reserves section records that redeployment. The limit and its catalogue-derived exemptions freeze with the roster snapshot; older snapshots without those facts remain startable. The limit is checked when a formation changes and again when the battle begins; moves into Strategic Reserves after the battle begins are not starting formations and do not consume it.
