...
| Leagues    | `league_created`, `league_recurring_enabled`, `league_event_created`, `league_joined`, `league_roster_submitted`, `league_rosters_revealed`, `league_battle_created`                                                                                                                                                  |
