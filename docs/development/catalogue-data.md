...
- Ability timing is prose, not structured catalogue data. Roster reminders may suggest one or more phase or turn triggers from familiar wording, including a different turn scope for each trigger, but the player confirms or replaces every suggestion; unfamiliar wording is left blank rather than guessed.
